...
Future<String> findPlate(String imagePath) async {
  var image = File(imagePath);
  var imageBytes = image.readAsBytesSync();
  final file = http.MultipartFile.fromBytes('upload', imageBytes,
...
Future<void> openPlatePage(String plate) async {
  var url = "https://centraalbeheer.finnik.nl/kenteken/" + plate;
